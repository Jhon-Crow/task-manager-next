...
import { setCompletedToTask, TaskPageCard } from "@/entities/task";
...
export const TaskReviewPermission = ({
  task,
  sessionUser,
}: {
  task: TypeTask;
  ...
  <div className="container mx-auto py-8 px-4 max-w-5xl">
    <div className="space-y-8">
      <div className="flex -space-x-2 h-full max-w-[750px] justify-start">
        <RejectButton taskId={task.id} userId={sessionUser.id} />
        <TaskPageCard
  ...
  return (
    <Dialog>
      <DropdownMenu>
        ...
        <DropdownMenuContent
          align="start"
          className="min-w-2xl space-y-2 ml-6.5"
        >
          <form
